...
nam = '/Users/seetha/Desktop/Mahathi-Spontaneous/Data/Fish060/Fish060_7fps_gng8GCaMP6s_9dpf_multidirec_noAvg_galvano_DU4_noPump_5minSpontHb_5minWith8pulsesBlueLightfor20s_5minSpont.tif';          % insert path to tiff stack here
sframe=1;						% user input: first frame to read (optional, default 1)
num2read=6321;					% user input: how many frames to read   (optional, default until the end)
...
% display centers of found componentss
...
figure;
[Coor,json_file, Centroids] = plot_contours(A_or,reshape(P.sn,d1,d2),contour_threshold,1); % contour plot of spatial footprints
%savejson('jmesh',json_file,'filename');        % optional save json file with component coordinates (requires matlab json library)
%% display components
plot_components_GUI(Yr,A_or,C_or,b2,f2,Cn,options)

%% Label as medial or lateral
C_or_transpose = C_or';
Centroids_arrange = [C_or(:,2), C_or(:,1)];
Centroids_arrange = Centroids_arrange';
Data = vertcat(Centroids_arrange, C_or_transpose);

SaveData = label_as_medial_or_lateral(Data, Centroids);
save('/Users/seetha/Desktop/Mahathi-Spontaneous/Data/Fish060/Fish060_ROIData.mat', 'SaveData')
%% make movie
